...
export default {
  ...
  methods: {
    ...
    saveExel() {
      ...
      axios.post("api/product/import_excel", data).then((res) => {
        this.$Swal({
          title: "succes",
          text: "all data",
          icon: "succes",
