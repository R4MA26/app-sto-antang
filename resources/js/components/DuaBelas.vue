                  ...
                  <div class="form-group">
                    <table class="table">
                      <tr>
                        <a
                          style="margin: 5px"
                          href="/api/duabelas/export_excel/"
...
export default {
  ...
  methods: {
    ...
    saveExel() {
      ...
      axios.post("api/duabelas/import_excel", data).then((res) => {
        this.$Swal({
          title: "succes",
          text: "all data",
          icon: "succes",
    ...
    loadProducts() {
      ...
      axios.get("api/duabelas/export_excel");
      // .then(()=>{
      //     toast({
      //         type: 'success',
