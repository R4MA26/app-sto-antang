...
export default {
  ...
  methods: {
    ...
    saveExel() {
      ...
      axios.post("api/sebelas/import_excel", data).then((res) => {
        this.$Swal({
          title: "succes",
          text: "all data",
          icon: "succes",
    ...
    loadProducts() {
      ...
      axios.get("api/sebelas/export_excel");
      // .then(()=>{
      //     toast({
      //         type: 'success',
