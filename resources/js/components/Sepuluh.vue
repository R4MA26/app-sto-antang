...
export default {
  ...
  methods: {
    ...
    saveExel() {
      ...
      axios.post("api/sepuluh/import_excel", data).then((res) => {
        this.$Swal({
          title: "succes",
          text: "all data",
          icon: "succes",
    ...
    loadProducts() {
      ...
      axios.get("api/sepuluh/export_excel");
      // .then(()=>{
      //     toast({
      //         type: 'success',
